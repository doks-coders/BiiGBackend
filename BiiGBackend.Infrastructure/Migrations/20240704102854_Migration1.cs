        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionCaption = table.Column<string>(type: "text", nullable: false),
                    CollectionImageUrl = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductDetailsUploaded = table.Column<bool>(type: "boolean", nullable: false),
                    ProductName = table.Column<string>(type: "text", nullable: true),
                    ProductBrandId = table.Column<Guid>(type: "uuid", nullable: true),
                    ProductCategoryId = table.Column<Guid>(type: "uuid", nullable: true),
                    ProductDescription = table.Column<string>(type: "text", nullable: true),
                    ProductSizes = table.Column<string>(type: "text", nullable: true),
                    ProductDiscountPercent = table.Column<int>(type: "integer", nullable: true),
                    IsDiscounted = table.Column<bool>(type: "boolean", nullable: false),
                    ProductRealPrice = table.Column<double>(type: "double precision", nullable: true),
                    ProductImage = table.Column<string>(type: "text", nullable: true),
                    ProductStockAmount = table.Column<int>(type: "integer", nullable: true),
                    isFeatured = table.Column<bool>(type: "boolean", nullable: true),
                    isRecentlyAdded = table.Column<bool>(type: "boolean", nullable: true),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductItems_Brands_ProductBrandId",
                        column: x => x.ProductBrandId,
                        principalTable: "Brands",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductItems_Categories_ProductCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderedRealPrice = table.Column<double>(type: "double precision", nullable: false),
                    OrderedDisplayPrice = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photos_ProductItems_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductItems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItems_ProductBrandId",
                table: "ProductItems",
